#!/usr/bin/python
################################################################################
# 252fa8a0-5cc5-11e4-af55-00155d01fe08
#
# Justin Dierking
...
class Finding:
    def __init__(self):
        ...
        self.uuid = "252fa8a0-5cc5-11e4-af55-00155d01fe08"
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.output = [r'HKCU:\Software\Policies\Microsoft\Office\15.0\outlook\options\mail', ('Message RTF Format=' + str(dword))]
