#!/usr/bin/python
################################################################################
# 27239f4a-5cc5-11e4-af55-00155d01fe08
#
# Justin Dierking
...
class Finding:
    def __init__(self):
        ...
        self.uuid = "27239f4a-5cc5-11e4-af55-00155d01fe08"
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.output = [r'HKCU:\Software\Policies\Microsoft\Office\12.0\Common\Internet', ('DisableCustomerSubmittedUpload=' + str(dword))]
