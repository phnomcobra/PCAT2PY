#!/usr/bin/python
################################################################################
# 212b2d2e-5cc5-11e4-af55-00155d01fe08
#
# Justin Dierking
...
class Finding:
    def __init__(self):
        ...
        self.uuid = "212b2d2e-5cc5-11e4-af55-00155d01fe08"
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.output = [r'HKLM:\Software\Policies\Microsoft\Internet Explorer\Main\FeatureControl\FEATURE_RESTRICT_FILEDOWNLOAD', ('(Reserved)=' + sz)]
