#!/usr/bin/python
################################################################################
# 20b5d092-5cc5-11e4-af55-00155d01fe08
#
# Justin Dierking
...
class Finding:
    def __init__(self):
        ...
        self.uuid = "20b5d092-5cc5-11e4-af55-00155d01fe08"
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.output = [r'HKCU:\Software\Policies\Microsoft\Office\12.0\Outlook\Security', ('UseCRLChasing=' + str(dword))]
