#!/usr/bin/python
################################################################################
# 242f6a08-5cc5-11e4-af55-00155d01fe08
#
# Justin Dierking
...
class Finding:
    def __init__(self):
        ...
        self.uuid = "242f6a08-5cc5-11e4-af55-00155d01fe08"
    ...
    def fix(self, cli):
        ...
        cli.powershell(r"Set-ItemProperty -path 'HKLM:\Software\Policies\Microsoft\Windows\EventLog\System' -name 'MaxSize' -value 16384 -Type DWord")
