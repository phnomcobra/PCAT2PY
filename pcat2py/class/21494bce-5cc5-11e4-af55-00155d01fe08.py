#!/usr/bin/python
################################################################################
# 21494bce-5cc5-11e4-af55-00155d01fe08
#
# Justin Dierking
...
class Finding:
    def __init__(self):
        ...
        self.uuid = "21494bce-5cc5-11e4-af55-00155d01fe08"
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.output = [r'HKCU:\software\policies\Microsoft\office\15.0\common\broadcast', ('disabledefaultservice=' + str(dword))]
