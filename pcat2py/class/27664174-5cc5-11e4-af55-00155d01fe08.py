#!/usr/bin/python
################################################################################
# 27664174-5cc5-11e4-af55-00155d01fe08
#
# Justin Dierking
...
class Finding:
    def __init__(self):
        ...
        self.uuid = "27664174-5cc5-11e4-af55-00155d01fe08"
    ...
    def check(self, cli):
        ...
        for line in self.output:
            if line.startswith("password") and "dcredit=-1" in line:
