#!/usr/bin/python
################################################################################
# 20be78c8-5cc5-11e4-af55-00155d01fe08
#
# Justin Dierking
...
class Finding:
    def __init__(self):
        ...
        self.uuid = "20be78c8-5cc5-11e4-af55-00155d01fe08"
    ...
    def fix(self, cli):
        ...
        cli.powershell(r"Set-ItemProperty -path 'HKLM:\Software\Policies\Microsoft\Windows\EventLog\Security' -name 'MaxSize' -value 81920 -Type DWord")
