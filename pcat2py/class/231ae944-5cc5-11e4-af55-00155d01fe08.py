#!/usr/bin/python
################################################################################
# 231ae944-5cc5-11e4-af55-00155d01fe08
#
# Justin Dierking
...
class Finding:
    def __init__(self):
        ...
        self.uuid = "231ae944-5cc5-11e4-af55-00155d01fe08"
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.output = [r'HKLM:\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\4', ('2004=' + str(dword))]
