#!/usr/bin/python
################################################################################
# 27424d96-5cc5-11e4-af55-00155d01fe08
#
# Justin Dierking
...
class Finding:
    def __init__(self):
        ...
        self.uuid = "27424d96-5cc5-11e4-af55-00155d01fe08"
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.output = [r'HKCU:\Software\Policies\Microsoft\Office\14.0\word\security\fileblock', ('Word12BetaFilesFromConverters=' + str(dword))]
