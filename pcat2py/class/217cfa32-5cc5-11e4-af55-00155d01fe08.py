#!/usr/bin/python
################################################################################
# 217cfa32-5cc5-11e4-af55-00155d01fe08
#
# Justin Dierking
...
class Finding:
    def __init__(self):
        ...
        self.uuid = "217cfa32-5cc5-11e4-af55-00155d01fe08"
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.output = [r'HKCU:\Software\Policies\Microsoft\Internet Explorer\Control Panel', ('FormSuggest=' + str(dword))]
    ...
    def fix(self, cli):
        ...
        cli.powershell(r"Set-ItemProperty -path 'HKCU:\Software\Policies\Microsoft\Internet Explorer\Control Panel' -name 'FormSuggest' -value 1 -Type DWord")
