#!/usr/bin/python
################################################################################
# 210b1f16-5cc5-11e4-af55-00155d01fe08
#
# Justin Dierking
...
class Finding:
    def __init__(self):
        ...
        self.uuid = "210b1f16-5cc5-11e4-af55-00155d01fe08"
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.output = [r'HKLM:\System\CurrentControlSet\Control\Session Manager\Kernel', ('ObCaseInsensitive=' + str(dword))]
