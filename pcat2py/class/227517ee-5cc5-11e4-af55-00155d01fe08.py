#!/usr/bin/python
################################################################################
# 227517ee-5cc5-11e4-af55-00155d01fe08
#
# Justin Dierking
...
class Finding:
    def __init__(self):
        ...
        self.uuid = "227517ee-5cc5-11e4-af55-00155d01fe08"
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.output = [r'HKCU:\software\policies\Microsoft\office\15.0\excel\options\binaryoptions', ('fUpdateExt_78_1=' + str(dword))]
