#!/usr/bin/python
################################################################################
# 25c92c28-5cc5-11e4-af55-00155d01fe08
#
# Justin Dierking
...
class Finding:
    def __init__(self):
        ...
        self.uuid = "25c92c28-5cc5-11e4-af55-00155d01fe08"
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.output = [r'HKCU:\Software\Policies\Microsoft\Office\14.0\powerpoint\slide libraries', ('DisableSlideUpdate=' + str(dword))]
