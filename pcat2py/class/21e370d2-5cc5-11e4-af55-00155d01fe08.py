#!/usr/bin/python
################################################################################
# 21e370d2-5cc5-11e4-af55-00155d01fe08
#
# Justin Dierking
...
class Finding:
    def __init__(self):
        ...
        self.uuid = "21e370d2-5cc5-11e4-af55-00155d01fe08"
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.output = [r'HKLM:\Software\Microsoft\Windows\CurrentVersion\Policies\Ext', ('NoFirsttimeprompt=' + str(dword))]
