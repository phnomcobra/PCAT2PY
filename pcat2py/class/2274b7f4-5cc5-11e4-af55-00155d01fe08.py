#!/usr/bin/python
################################################################################
# 2274b7f4-5cc5-11e4-af55-00155d01fe08
#
# Justin Dierking
...
class Finding:
    def __init__(self):
        ...
        self.uuid = "2274b7f4-5cc5-11e4-af55-00155d01fe08"
	...
	# Recommended MultiSZ
	rec_multi_sz = ("BROWSER,NETLOGON,SAMR")
    ...
    def fix(self, cli):
        ...
        cli.powershell(r"Set-ItemProperty -path 'HKLM:\SYSTEM\CurrentControlSet\services\LanmanServer\Parameters' -name 'NullSessionPipes' -Type MultiString -value BROWSER,NETLOGON,SAMR")
