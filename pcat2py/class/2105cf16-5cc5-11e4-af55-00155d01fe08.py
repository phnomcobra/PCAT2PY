#!/usr/bin/python
################################################################################
# 2105cf16-5cc5-11e4-af55-00155d01fe08
#
# Justin Dierking
...
class Finding:
    def __init__(self):
        ...
        self.uuid = "2105cf16-5cc5-11e4-af55-00155d01fe08"
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.output = [r'HKLM:\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\4', ('1208=' + str(dword))]
    ...
    def fix(self, cli):
        ...
        cli.powershell(r"Set-ItemProperty -path 'HKLM:\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\4' -name '1208' -value 3 -Type DWord")
