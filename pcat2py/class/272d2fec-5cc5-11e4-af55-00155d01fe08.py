#!/usr/bin/python
################################################################################
# 272d2fec-5cc5-11e4-af55-00155d01fe08
#
# Justin Dierking
...
class Finding:
    def __init__(self):
        ...
        self.uuid = "272d2fec-5cc5-11e4-af55-00155d01fe08"
    ...
    def check(self, cli):
        ...
        # Output Lines
        self.output = [r'HKCU:\Software\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\2', ('1A04=' + str(dword))]
